...
export interface User {
  ...
  role: 'admin' | 'user';
  /**
   * Preferred color theme (syncs across devices)
   */
   ...
   */
  lastAuthMethod?: ('github' | 'email') | null;
  /**
   * Updated on every successful OAuth sign-in.
   */
  ...
  /**
   * GitHub username captured from OAuth profile.login.
   */
...
export interface Blog {
   ...
   */
  excerpt?: string | null;
  type: 'deep-dive' | 'product-review' | 'news' | 'guide' | 'research' | 'other';
